    ...
    <>
      ...
      <Row className="mb-3">
        <Form.Group as={Col} md="4" controlId="formGridState">
          ...
          <Form.Select defaultValue="Choose Specialization" required>
          <Form.Control required as="select" type="select" name="Specialization"></Form.Control>
        ...
        <Form.Group as={Col} md="4" controlId="formGridState">
          ...
          <Form.Select defaultValue="Choose Designation" required>
          <Form.Control required as="select" type="select" name="Designation"></Form.Control>
        ...
        <Form.Group as={Col} md="4" controlId="formGridState">
          ...
          <Form.Select defaultValue="Choose CRED" required>
          <Form.Control required as="select" type="select" name="CRED"></Form.Control>
          <option value="">Choose CRED</option>
